...
if(isset($_POST['signupBtn'])){
    ...
    //collect from data and store in variables
    $email = $_POST['email'];
    ...
    {
    	$result = flashMessage("Email is already taken, please try another email");
    }

    else if(checkDuplicateUsername($username, $db))
    {
    	$result = flashMessage("Username is already taken, please try another username");
    }
        ...
        try{
            ...
            if($statement->rowCount() == 1){
                ...
                //prepare email body
                    ...
                    <h2>The City of Boston: Community Preservation Act</h2>
                    
                    <p>Welcome '.$username.'<br><br>Thank you for registering, please click on the link below to
                        confirm your email address</p>
                    
                    <p><a href="http://localhost/SeniorProject/activate.php?id='.$encode_id.'"> Confirm Email</a></p>
                    
                    <p><strong>&copy;2019 City of Boston</strong></p>
                ...
                $mail->Subject = "Message from the City of Boston";
                $mail->Body = $mail_body;
                ...
                if(!$mail->Send()){
                    ...
                    $result = "<script type=\"text/javascript\">
                            ...
                            text: \"You have successfully registered. Please check your email for the confirmation link\",
                            type: 'success',
